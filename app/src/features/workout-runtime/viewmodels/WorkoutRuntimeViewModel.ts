...
export class WorkoutRuntimeViewModel {
  private readonly service: WorkoutRuntimeExperienceService;
  private readonly now: () => Date;
  private readonly listeners = new Set<() => void>();

  private _runtime: WorkoutRuntime | null = null;
  private _loading: WorkoutLoadingState = createWorkoutLoadingState(
  ...
  constructor(deps: WorkoutRuntimeViewModelDeps = {}) {
    this.service = deps.service ?? workoutRuntimeExperienceService;
