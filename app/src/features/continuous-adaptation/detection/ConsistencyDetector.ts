...
export function detectConsistency(input: AdaptationInput): {
  ...
  const triggers = Object.freeze(
    keys.map((signalKey, i) =>
      freezeTrigger({
        ...
        kind: AdaptationTriggerKinds.CONSISTENCY,
        signalKey,
...
export const ConsistencyDetector = { detect: detectConsistency };
