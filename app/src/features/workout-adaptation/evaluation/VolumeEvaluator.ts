...
export interface VolumeEvaluation {
...
const ORDINAL_TABLE: Readonly<Record<string, number>> = Object.freeze({"volume":1,"decision:key:volume":1});

const PREFIXES: readonly string[] = Object.freeze(["volume","decision:key:volume"]);
...
export function evaluateVolume(signalKeys: readonly string[]): VolumeEvaluation {
