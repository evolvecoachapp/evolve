...
const ORDINAL_TABLE: Readonly<Record<string, number>> = Object.freeze({"intensity":1,"decision:key:intensity":1});

const PREFIXES: readonly string[] = Object.freeze(["intensity","decision:key:intensity"]);
...
export function evaluateIntensity(signalKeys: readonly string[]): IntensityEvaluation {
