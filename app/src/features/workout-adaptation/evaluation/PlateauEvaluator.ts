...
const ORDINAL_TABLE: Readonly<Record<string, number>> = Object.freeze({"plateau":1,"decision:key:plateau":1});

const PREFIXES: readonly string[] = Object.freeze(["plateau","decision:key:plateau"]);
...
export function evaluatePlateau(signalKeys: readonly string[]): PlateauEvaluation {
