...
const ORDINAL_TABLE: Readonly<Record<string, number>> = Object.freeze({"progression":1,"decision:key:progression":1});

const PREFIXES: readonly string[] = Object.freeze(["progression","decision:key:progression"]);
...
export function evaluateProgression(signalKeys: readonly string[]): ProgressionEvaluation {
