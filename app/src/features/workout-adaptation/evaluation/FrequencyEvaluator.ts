...
const ORDINAL_TABLE: Readonly<Record<string, number>> = Object.freeze({"frequency":2,"decision:key:frequency":2});

const PREFIXES: readonly string[] = Object.freeze(["frequency","decision:key:frequency"]);
...
export function evaluateFrequency(signalKeys: readonly string[]): FrequencyEvaluation {
