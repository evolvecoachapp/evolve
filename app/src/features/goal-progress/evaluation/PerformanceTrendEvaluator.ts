...
export function evaluatePerformanceTrend(input: GoalProgressInput): {
  ...
  const triggers = Object.freeze(
    keys.map((signalKey, i) =>
      freezeTrigger({
        ...
        kind: GoalAchievementKinds.TREND,
        signalKey,
...
export const PerformanceTrendEvaluator = { detect: evaluatePerformanceTrend };
