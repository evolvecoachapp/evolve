...
export interface HRVEvaluation {
...
const ORDINAL_TABLE: Readonly<Record<string, number>> = Object.freeze({"hrv":1,"state:hrv":1,"decision:key:hrv":1});

const PREFIXES: readonly string[] = Object.freeze(["hrv","state:hrv","decision:key:hrv"]);
...
export function evaluateHRV(signalKeys: readonly string[]): HRVEvaluation {
