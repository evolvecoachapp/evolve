...
export interface DayTimingEvaluation {
...
const ORDINAL_TABLE: Readonly<Record<string, number>> = Object.freeze({"timing":2,"readiness":2,"decision:key:timing":2});

const PREFIXES: readonly string[] = Object.freeze(["timing","readiness","decision:key:timing"]);
...
export function evaluateReadiness(signalKeys: readonly string[]): DayTimingEvaluation {
