...
const ORDINAL_TABLE: Readonly<Record<string, number>> = Object.freeze({"sleep":1,"decision:key:sleep":1});

const PREFIXES: readonly string[] = Object.freeze(["sleep","decision:key:sleep"]);
...
export function evaluateSleep(signalKeys: readonly string[]): SleepEvaluation {
