...
const ORDINAL_TABLE: Readonly<Record<string, number>> = Object.freeze({"adherence":1,"state:adherence":1,"decision:key:adherence":1});

const PREFIXES: readonly string[] = Object.freeze(["adherence","state:adherence","decision:key:adherence"]);
...
export function evaluateAdherence(signalKeys: readonly string[]): AdherenceEvaluation {
