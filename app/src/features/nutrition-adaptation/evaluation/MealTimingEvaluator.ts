...
export interface MealTimingEvaluation {
...
const ORDINAL_TABLE: Readonly<Record<string, number>> = Object.freeze({"timing":2,"meal-timing":2,"decision:key:timing":2});

const PREFIXES: readonly string[] = Object.freeze(["timing","meal-timing","decision:key:timing"]);
...
export function evaluateMealTiming(signalKeys: readonly string[]): MealTimingEvaluation {
