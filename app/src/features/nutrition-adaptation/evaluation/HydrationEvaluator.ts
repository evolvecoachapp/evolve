...
export interface HydrationEvaluation {
...
const ORDINAL_TABLE: Readonly<Record<string, number>> = Object.freeze({"hydration":0,"state:hydration":0});

const PREFIXES: readonly string[] = Object.freeze(["hydration","state:hydration"]);
...
export function evaluateHydration(signalKeys: readonly string[]): HydrationEvaluation {
