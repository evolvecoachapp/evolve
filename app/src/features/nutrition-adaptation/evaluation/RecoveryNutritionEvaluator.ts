...
export interface RecoveryNutritionEvaluation {
...
const ORDINAL_TABLE: Readonly<Record<string, number>> = Object.freeze({"recovery-nutrition":0,"recovery":0,"state:recovery":0});

const PREFIXES: readonly string[] = Object.freeze(["recovery-nutrition","recovery","state:recovery"]);
...
export function evaluateRecoveryNutrition(signalKeys: readonly string[]): RecoveryNutritionEvaluation {
