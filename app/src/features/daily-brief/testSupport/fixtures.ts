...
export const FIXED_BRIEF_TIMESTAMP = "2026-07-28T12:00:00.000Z";

export function createBriefClock(start = FIXED_BRIEF_TIMESTAMP): {
  readonly now: () => string;
...
export function createTestDailyBriefService(
  overrides: {
    ...
    readonly homeExperience?: HomeExperienceService;
  } = {},
): DailyBriefService {
  const clock = overrides.clock ?? (() => FIXED_BRIEF_TIMESTAMP);
  const coachTimeline =
  ...
  return createDailyBriefService({
    homeExperience,
    coachTimeline,
    planHistory,
    proactiveInsights,
...
export function createStubPlanHistory(
  ...
  return {
    ...
    createdAt: FIXED_BRIEF_TIMESTAMP,
    updatedAt: FIXED_BRIEF_TIMESTAMP,
...
export function createStubInsight(
  ...
  return Object.freeze({
    ...
    timestamp: overrides.timestamp ?? FIXED_BRIEF_TIMESTAMP,
...
export function createStubCoachingSession(
  ...
  return Object.freeze({
    ...
    timestamp: FIXED_BRIEF_TIMESTAMP,
