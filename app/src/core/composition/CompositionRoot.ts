...
export class CompositionRoot {
  ...
  static create(options: CompositionRootOptions = {}): CompositionRoot {
    ...
    const createLoggerBundle = (() => {
      let bundle: ReturnType<typeof LoggerFactory.create> | undefined;
      return () => {
        if (!bundle) {
          bundle = LoggerFactory.create();
        }
        return bundle;
      };
    })();
    ...
    container.register(
      "LoggerRegistry",
      () => createLoggerBundle().registry,
      { lifecycle },
    );

    container.register(
      "MockLogger",
      () => createLoggerBundle().mockLogger,
      { lifecycle },
    );

    container.register("LoggerFactory", () => LoggerFactory, { lifecycle });
    ...
    let workoutProgressIntegration:
      | ReturnType<typeof WorkoutProgressIntegrationFactory.create>
      | undefined;

    container.register(
      "WorkoutProgressPublisher",
      () => {
        workoutProgressIntegration ??= WorkoutProgressIntegrationFactory.create();
        return workoutProgressIntegration.publisher;
      },
      { lifecycle },
    );
    ...
    container.register(
      ...
      () => {
        workoutProgressIntegration ??= WorkoutProgressIntegrationFactory.create();
        return workoutProgressIntegration.subscriber;
      },
      { lifecycle },
    );

    let nutritionProgressIntegration:
      | ReturnType<typeof NutritionProgressIntegrationFactory.create>
      | undefined;

    container.register(
      "NutritionProgressPublisher",
      () => {
        nutritionProgressIntegration ??= NutritionProgressIntegrationFactory.create();
        return nutritionProgressIntegration.publisher;
      },
      { lifecycle },
    );
    ...
    container.register(
      ...
      () => {
        nutritionProgressIntegration ??= NutritionProgressIntegrationFactory.create();
        return nutritionProgressIntegration.subscriber;
      },
      { lifecycle },
    );
  ...
  getLoggerRegistry(): ServiceMap["LoggerRegistry"] {
    return this.registry.resolve("LoggerRegistry");
  }

  getMockLogger(): ServiceMap["MockLogger"] {
    return this.registry.resolve("MockLogger");
  }

  getLoggerFactory(): ServiceMap["LoggerFactory"] {
    return this.registry.resolve("LoggerFactory");
  }

  getWorkoutProgressPublisher(): ServiceMap["WorkoutProgressPublisher"] {
    return this.registry.resolve("WorkoutProgressPublisher");
  }

  getProgressAnalyticsSubscriber(): ServiceMap["ProgressAnalyticsSubscriber"] {
    return this.registry.resolve("ProgressAnalyticsSubscriber");
  }

  getNutritionProgressPublisher(): ServiceMap["NutritionProgressPublisher"] {
    return this.registry.resolve("NutritionProgressPublisher");
  }
