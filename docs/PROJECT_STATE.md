...
| SQLite Adapter | `infrastructure/sqlite` | Foundation complete (30.1); Native persistent engine (34.2) — Expo SQLite driver behind Persistence Contracts; database survives restart |
...
Current: **34.1 — SQLite Runtime Persistence Activation** (2026-08-10)
