...
**25.4 — Coach Timeline & Decision Journal** (2026-07-27)
...
Downstream consumers of plan history / restore (persistence, richer nutrition conversation restore UX) — without embedding domain logic in composition adapters.
