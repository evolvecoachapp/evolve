...
**Purpose:** Describe the mobile AI / coach runtime stack, including Coaching Session Runtime, Athlete State, and Context Fusion placement.  
...
## Coach Interaction Path (Sprint 22.2)
...
Context Fusion Engine             ← Sprint 22.2 (immutable UnifiedCoachingContext)
  ↓
Decision Engine                   ← consumes DecisionEngineContext
  ↓
...
Unified Coach Response
  ↓
SessionResult / AthleteState / UnifiedCoachingContext / DecisionEngineContext
```
...
| Decision Engine | decision runtime | Consume fused context; produce decisions (not fusion) |
