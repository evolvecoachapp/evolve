...
Context Fusion Engine            ← Sprint 22.2 (implemented) — fuse runtimes/agents into UnifiedCoachingContext
  ...
  ↓
Decision Engine                  ← consumes UnifiedCoachingContext / DecisionEngineContext (no fusion here)
  ↓
