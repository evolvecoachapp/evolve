...
Recommendation Engine            ← Sprint 22.4 (implemented) — CoachingDecision → CoachingRecommendation
  ...
  ↓
Explainability Engine            ← consumes ExplainabilityInput (downstream)
  ↓
