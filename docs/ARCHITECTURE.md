...
Decision Engine                  ← Sprint 22.3 (implemented) — UnifiedCoachingContext → CoachingDecision
  ...
  ↓
Recommendation Engine            ← consumes RecommendationEngineInput (downstream)
  ↓
