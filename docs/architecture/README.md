...
- [AI_RUNTIME.md](../AI_RUNTIME.md) — Mobile AI / coach runtime stack (Conversation → Session → Athlete State → Context Fusion → Decision Engine → Recommendation Engine → Explainability Engine → Continuous Adaptation Engine → Workout Adaptation Engine)
